...
SOURCE_SYSTEM_TABLE          = f"{DEFAULT_CATALOG}.pfl_x_schema.config_source_system"
CONFIG_MASTER_TABLE          = f"{DEFAULT_CATALOG}.pfl_x_schema.config_master"
AUDIT_TABLE                  = f"{DEFAULT_CATALOG}.pfl_x_schema.tb_audit_log"
DEPENDENCY_TABLE             = f"{DEFAULT_CATALOG}.pfl_x_schema.dependency_master_config"
...
def build_table_refs(catalog_name: str) -> dict:
    ...
    return {
        ...
        "pipeline_master_config_table": PIPELINE_MASTER_CONFIG_TABLE,
    }
...
class ConfigManager:
    ...
    def get_active_tasks(
        ...
        SourceSystemConfig,
        list[IngestionTaskConfig | MavisIngestionTaskConfig | LentraIngestionTaskConfig],
    ]:
        """
